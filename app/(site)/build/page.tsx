            ...
            <div className="w-full px-4 lg:w-4/4 mx-auto">
              <div className="blog-details blog-details-docs rounded-sm bg-white py-11 px-8 shadow-three dark:bg-gray-dark sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
                <div className="flex items-center gap-8 lg:gap-19 mt-12.5 lg:mt-15 xl:mt-20">                  
                  ...
                  <div className=" md:w-1/2"> 
                    <h5 className="text-black dark:text-white font-medium uppercase">Build Your Vision with VNOC</h5>           
                    <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">Where Creativity Meets Automation</h2>
                    <p>
                ...
                <div className="flex items-center gap-8 lg:gap-19 mt-12.5 lg:mt-15 xl:mt-20">
                  <div className=" md:w-1/2"> 
                    <h5 className="text-black dark:text-white font-medium uppercase">Streamlined Brand Creation</h5>           
                    <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">AI-Powered Auto Frameworks and Categorization</h2>
                    <p>
                ...
                <div className="flex items-center gap-8 lg:gap-19 mt-12.5 lg:mt-15 xl:mt-20">                  
                  ...
                  <div className=" md:w-1/2"> 
                    <h5 className="text-black dark:text-white font-medium uppercase">Unleash Your Creativity</h5>           
                    <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">Auto Task Orders and Content Generation</h2>
                    <p>
                ...
                <div className="flex items-center gap-8 lg:gap-19 mt-12.5 lg:mt-15 xl:mt-20">
                  <div className=" md:w-1/2"> 
                    <h5 className="text-black dark:text-white font-medium uppercase">Tap into the Power of Collaboration</h5>           
                    <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">VNOC's Contrib Network</h2>
                    <p>
                ...
                <div className="flex items-center gap-8 lg:gap-19 mt-12.5 lg:mt-15 xl:mt-20">                  
                  ...
                  <div className=" md:w-1/2"> 
                    <h5 className="text-black dark:text-white font-medium uppercase">Supercharge Your SEO</h5>           
                    <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">Insights from SpyFu</h2>
                    <p>
                ...
                <div className="flex items-center gap-8 lg:gap-19 mt-12.5 lg:mt-15 xl:mt-20">
                  <div className=" md:w-1/2"> 
                    <h5 className="text-black dark:text-white font-medium uppercase">Automated Partner Matching</h5>           
                    <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">Your Ideal Collaborators, Instantly</h2>
                    <p>
                ...
                <div className="flex items-center gap-8 lg:gap-19 mt-12.5 lg:mt-15 xl:mt-20">                  
                  ...
                  <div className=" md:w-1/2"> 
                    <h5 className="text-black dark:text-white font-medium uppercase">Efficiency at Every Step</h5>           
                    <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">Your Time-Saving Solution</h2>
                    <p>
                ...
                <div className="flex items-center gap-8 lg:gap-19 mt-12.5 lg:mt-15 xl:mt-20">
                  <div className=" md:w-1/2"> 
                    <h5 className="text-black dark:text-white font-medium uppercase">Get Started with VNOC Build</h5>           
                    <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">Redefine Possibilities</h2>
                    <p>
