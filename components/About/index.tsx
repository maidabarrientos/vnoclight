      ...
      <section className="pb-20 lg:pb-25 xl:pb-30 overflow-hidden">
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <Image
                src="/images/about/people-comm-2.png"
                alt="About"
            ...
            >
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>Concierge onboarding for founders with excellent and premium digital assets.</p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                <div className="w-15 h-15 rounded-[50%] border border-stroke dark:border-strokedark dark:bg-blacksection flex items-center justify-center">
                ...
                <div className="w-3/4">
                  ...
                  <p>Get matched with endless possibilies and projects.</p>
                </div>
              </div>
            </motion.div>
          </div>
